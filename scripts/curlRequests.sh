...
curl localhost:9090/users -XPOST -d '{"id":"a2181017-5c53-422b-b6bc-036b27c04fc8", "username":"username", "email":"test@email.com", "dateofbirth":"01/01/1970"}'
curl localhost:9090/users -XPUT -d '{"id":"a2181017-5c53-422b-b6bc-036b27c04fc8", "username":"newUSername", "email":"test123@email.com", "dateofbirth":"01/01/1970"}'
